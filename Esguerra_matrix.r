...
## Matrix inversions are usually a costly computation and there may be some benefit to caching the inverse of a matrix rather than compute it repeatedly.
...
## This function can compute the inverse of the special "matrix" created by 
